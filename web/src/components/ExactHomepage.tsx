    ...
    <div className="exact-page-root">
      <style>{`
        ...
        .exact-page-root header {
          ...
          background:rgba(10,18,24,.85); backdrop-filter:blur(10px);
        ...
        .exact-page-root .brand img { width:34px; height:34px; }
        ...
        .exact-page-root .btn:hover { transform:translateY(-2px); box-shadow:0 10px 26px rgba(0,229,160,.25); }
        ...
        /* hero */
        .exact-page-root .hero { position:relative; padding:170px 0 90px; overflow:hidden; }
        .exact-page-root .hero::before {
          content:""; position:absolute; inset:0;
          background:radial-gradient(900px 480px at 82% -10%,rgba(0,229,160,.09),transparent 60%);
        }
        .exact-page-root .hero .wrap {
          position:relative; display:grid; grid-template-columns:1.05fr .95fr; gap:54px; align-items:center;
        }
        ...
        .exact-page-root h1 em { font-style:normal; color:var(--mint); }
        ...
        .exact-page-root .term-bar .live { margin-left:auto; color:var(--mint); }
        .exact-page-root .term-bar .live::before { content:"●"; margin-right:6px; animation:dotPulse 2s infinite; }
        ...
        .exact-page-root h2 em { font-style:normal; color:var(--mint); }
        ...
        .exact-page-root .card:hover { transform:translateY(-5px); border-color:rgba(0,229,160,.4); }
        ...
        .exact-page-root .metric .n { font-size:36px; font-weight:800; font-family:var(--mono); }
        ...
        .exact-page-root .foot a { color:var(--dim); }
      ...
      <header>
        <div className="wrap nav">
          <div className="brand" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <svg viewBox="0 0 512 512" style={{ width: 34, height: 34 }}>
              <defs>
                <linearGradient id="exactShieldGrad" x1="0" y1="0" x2="1" y2="1">
                  <stop offset="0" stopColor="#00E5A0"/>
                  <stop offset="1" stopColor="#0091FF"/>
                </linearGradient>
              </defs>
              <path d="M256 40 L432 104 V268 C432 376 356 446 256 476 C156 446 80 376 80 268 V104 Z"
                    fill="none" stroke="url(#exactShieldGrad)" strokeWidth="22" strokeLinejoin="round"/>
        ...
        <div className="wrap">
          <div>
            ...
            <div className="cta-row">
              <button onClick={onGoToDashboard} className="btn">Watch It Work</button>
          ...
          <div className="term" id="demo">
            <div className="term-bar">
              ...
              <span style={{ marginLeft: 8 }}>pegwatch-agent — session</span>
              <span className="live">LIVE</span>
            </div>
            <div className="term-body">
              <div className="tl ok" style={{ animationDelay: '.3s' }}>
                <span className="ts">02:59:41</span>
                <span className="tag">[WATCH]</span>
                <span>TSLAx peg 0.998 · inside band ±2%</span>
              </div>
              <div className="tl ok" style={{ animationDelay: '1.0s' }}>
                <span className="ts">03:00:12</span>
                <span className="tag">[WATCH]</span>
                <span>TSLAx peg 0.987 · inside band ±2%</span>
              </div>
              <div className="tl warn" style={{ animationDelay: '1.7s' }}>
              ...
              <div className="chart">
                <svg viewBox="0 0 520 130">
                  ...
                  <line x1="10" y1="30" x2="510" y2="30" stroke="#00E5A0" strokeWidth="1.5" strokeDasharray="6 5" opacity=".7"/>
                  <line x1="10" y1="76" x2="510" y2="76" stroke="#0091FF" strokeWidth="1.5" strokeDasharray="6 5" opacity=".7"/>
                  <path d="M10 55 C70 48 110 62 170 55 C230 48 270 66 330 72 C390 78 440 96 480 108"
                        fill="none" stroke="#E8F0EC" strokeWidth="3" strokeLinecap="round"/>
                  <circle cx="480" cy="108" r="6" fill="#FF5470"/>
